  ...
  return (
    <div>
      ...
      <div className="bg-gray-900 min-h-screen flex flex-col text-white h-full">
        <div className="p-6 max-w-7xl w-full mx-auto flex flex-col">
          ...
          {buyers.length > 0 ? (
            ...
            <div className="p-4 py-8 flex flex-col items-center gap-4 text-center text-gray-500">
              {searchParams.search ? (
                <>
                ...
                <>
                  <p className="mb-4 text-xl">
                    No buyers found. Try creating one.
                  </p>
                  <Link
                    href="/buyers/new"
                    className="bg-indigo-600 w-max text-white p-3 font-semibold rounded-lg"
